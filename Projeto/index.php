...
<body>
        <nav class="cabecalho">
            ...
            <div class="menu">
                <ul>
                    ...
                    <li> <a href="apresentacoes.php"> Sobre nós </a> </li>
        ...
        <main>
            <div class="container">
                ...
                <p>Certamente há outros importantes tópicos, inclusive alguns mais relacionados a devOps. É importante buscar por esse tipo de conhecimento. Como desenvolvedores web não precisamos criar soluções para segurança, devemos apenas entender e utilizar as existentes. Não cabe a nós criarmos, por exemplo, uma library para criptografia, não é da nossa alçada, tem gente muito mais preparada para isso. Agora, é muito importante que conheçamos as opções disponíveis e como elas podem nos ajudar em nossos projetos.</p>

                <p>Pelo fato de o PHP ser o motor de alguns dos maiores Sistema de Gerenciamento de Conteúdo(CMS's) do mercado como: <em><a href="https://br.wordpress.com/" target="_blank">WordPress</a>, <a href="https://www.drupal.org/" target="_blank">Drupal</a>, <a href="https://www.joomla.org/" target="_blank">Joomla</a>, <a href="https://magento.com/" target="_blank">Magento</a></em>, etc, é comum ler e notar vulnerabilidades que são encontradas nessas plataformas. E isso não é problema, desde que você se preocupe em sempre a utilizar as últimas versões e desde que elas se mantenham atualizadas (que é o caso). Algumas vulnerabilidades não são especificamente do PHP e sim de algum módulo externo como OpenSSL ou algo relacionado ao sistema operacional. Sim, o PHP, como qualquer outra plataforma, possui vulnerabilidades, sempre teve, sempre vai ter, por isso é sempre importante utilizar as últimas versões estáveis das tecnologias que você trabalha (e isso vale para tudo, desde a linguagem, uma simples library ou até mesmo o seu sistema operacional).</p>

                <p>É razoavelmente comum sistemas legados rodando em versões antigas do PHP. Não dá para cravar que tais sistemas precisam ser reescritos e migrados, tudo depende da criticidade das informações que eles trabalham e como é feita a auditoria de segurança neles.</p>

                <h2>Mas o PHP não é uma linguagem orientada a objetos?</h2>

                <p>Realmente, o PHP não é uma linguagem orientada a objetos, ele implementa o paradigma de orientação a objetos. O PHP é multiparadigma. Não existe demérito algum nisso. Não é o fato de uma linguagem ser (em essência) orientada a objetos que a faz ser a solução para todos os problemas. Por exemplo, atualmente é notório um movimento e uma grande adoção por linguagens funcionais.</p>
                ...
                <p>Pode ser que demore um pouco menos ou um pouco mais de um ano, tudo vai depender da estabilidade das alterações. Mas essa é a ideia principal. E para cada nova minor version, têm-se dois anos de suporte (bugs e segurança).</p>
                ...
                <P>O Symfony, Laravel e Zend Framework elevaram o nível do desenvolvimento com PHP. Há cases de aplicações com milhares de requisições por segundo e que utilizam algum desses frameworks.</P>

                <h2>Qual o real objetivo aqui?</h2>

                <p>O nosso interesse não é afirmar que o PHP é a melhor linguagem, muito menos sugerir que você pare tudo e comece a estudá-lo. Essa ideia de “melhor linguagem” cai muito no terreno da “relatividade”. A melhor é que resolve o problema do seu projeto e que a sua equipe consegue trabalhar bem com ela.</p>
                ...
                <p>Isso quer dizer que, não importa que linguagem você venha a escolher, desde que ela consiga entregar o valor final do seu produto. A escolha de uma linguagem / plataforma, principalmente em um ambiente corporativo, em um grande projeto, se passa por muitas decisões que vão além da nossa opinião e gosto pessoal.</p>
        ...
        <footer class="container-fluid">
            ...
            <div class="footer-copyright text-center py-3">© 2019 Etec Professor Camargo Aranha
                <a href="http://eteccamargoaranha.com.br/"> Etec Professor Camargo Aranha</a>
            </div>
        </footer>
    </div>
</body>
